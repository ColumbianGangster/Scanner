...
import com.spike.scanner.ui.mlkitscanner.MLKitScannerFragment

import pub.devrel.easypermissions.AfterPermissionGranted
import pub.devrel.easypermissions.EasyPermissions


class ZXingScannerFragment : Fragment(), EasyPermissions.PermissionCallbacks {

    private lateinit var scannerBottomSheetFragment: ScannerBottomSheetFragment


    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?):
            View? = com.spike.scanner.ui.mlkitscanner.inflate(R.layout.fragment_scan)
